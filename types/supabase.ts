    ...
    get: {
      parameters: {
        query: {
          ...
          cursor?: parameters["rowFilter.plaid_items.cursor"];
          /** Filtering Columns */
          select?: parameters["select"];
          /** Ordering */
          order?: parameters["order"];
    ...
    get: {
      parameters: {
        query: {
          ...
          split_amounts?: parameters["rowFilter.profiles_transactions.split_amounts"];
...
export interface parameters {
  ...
  /** Format: text */
  "rowFilter.plaid_items.cursor": string;
  /** @description groups */
  ...
  /** Format: jsonb */
  "rowFilter.profiles_transactions.split_amounts": string;
  /** Format: boolean */
