...
export interface paths {
	...
	"/shared_transactions_old": {
		get: {
			parameters: {
				query: {
					created_at?: parameters["rowFilter.shared_transactions_old.created_at"];
					group_id?: parameters["rowFilter.shared_transactions_old.group_id"];
					id?: parameters["rowFilter.shared_transactions_old.id"];
					split_amounts?: parameters["rowFilter.shared_transactions_old.split_amounts"];
					/** Filtering Columns */
					select?: parameters["select"];
					/** Ordering */
					order?: parameters["order"];
			...
			responses: {
				/** OK */
				200: {
					schema: definitions["shared_transactions_old"][];
				};
				/** Partial Content */
				206: unknown;
			};
		...
		post: {
			parameters: {
				body: {
					/** shared_transactions_old */
					shared_transactions_old?: definitions["shared_transactions_old"];
				};
				query: {
					/** Filtering Columns */
					select?: parameters["select"];
		...
		get: {
			parameters: {
				query: {
					...
					amount_received_users?: parameters["rowFilter.profiles_groups.amount_received_users"];
					/** Filtering Columns */
					select?: parameters["select"];
					/** Ordering */
					order?: parameters["order"];
		...
		get: {
			parameters: {
				query: {
					...
					edited_at?: parameters["rowFilter.comments.edited_at"];
					message?: parameters["rowFilter.comments.message"];
					created_by?: parameters["rowFilter.comments.created_by"];
					/** Filtering Columns */
					select?: parameters["select"];
					/** Ordering */
					order?: parameters["order"];
		...
		get: {
			parameters: {
				query: {
					...
					is_deleted?: parameters["rowFilter.shared_transactions.is_deleted"];
					profile_id?: parameters["rowFilter.shared_transactions.profile_id"];
	...
	"/profiles_transactions": {
		get: {
			parameters: {
				query: {
					created_at?: parameters["rowFilter.profiles_transactions.created_at"];
					amount?: parameters["rowFilter.profiles_transactions.amount"];
					authorized_date?: parameters["rowFilter.profiles_transactions.authorized_date"];
					category?: parameters["rowFilter.profiles_transactions.category"];
					category_id?: parameters["rowFilter.profiles_transactions.category_id"];
					date?: parameters["rowFilter.profiles_transactions.date"];
					merchant_name?: parameters["rowFilter.profiles_transactions.merchant_name"];
					name?: parameters["rowFilter.profiles_transactions.name"];
					payment_channel?: parameters["rowFilter.profiles_transactions.payment_channel"];
					payment_meta?: parameters["rowFilter.profiles_transactions.payment_meta"];
					pending?: parameters["rowFilter.profiles_transactions.pending"];
					transaction_id?: parameters["rowFilter.profiles_transactions.transaction_id"];
					transaction_type?: parameters["rowFilter.profiles_transactions.transaction_type"];
					account_id?: parameters["rowFilter.profiles_transactions.account_id"];
					location?: parameters["rowFilter.profiles_transactions.location"];
					id?: parameters["rowFilter.profiles_transactions.id"];
					is_deleted?: parameters["rowFilter.profiles_transactions.is_deleted"];
					profile_id?: parameters["rowFilter.profiles_transactions.profile_id"];
					/** Filtering Columns */
					select?: parameters["select"];
					/** Ordering */
					order?: parameters["order"];
			...
			responses: {
				/** OK */
				200: {
					schema: definitions["profiles_transactions"][];
				};
				/** Partial Content */
				206: unknown;
			};
		...
		post: {
			parameters: {
				body: {
					/** profiles_transactions */
					profiles_transactions?: definitions["profiles_transactions"];
				};
				query: {
					/** Filtering Columns */
					select?: parameters["select"];
...
export interface definitions {
	...
	shared_transactions_old: {
		 ...
		 * @description Note:
		 * This is a Primary Key.<pk/>
		 * This is a Foreign Key to `profiles_transactions.id`.<fk table='profiles_transactions' column='id'/>
		 */
		id: string;
		/** Format: jsonb */
...
export interface parameters {
	...
	/** @description shared_transactions_old */
	"body.shared_transactions_old": definitions["shared_transactions_old"];
	/** Format: timestamp with time zone */
	"rowFilter.shared_transactions_old.created_at": string;
	/** Format: uuid */
	"rowFilter.shared_transactions_old.group_id": string;
	/** Format: uuid */
	"rowFilter.shared_transactions_old.id": string;
	/** Format: jsonb */
	"rowFilter.shared_transactions_old.split_amounts": string;
	...
	/** Format: double precision */
	"rowFilter.profiles_groups.amount_received_users": string;
	...
	/** Format: timestamp with time zone */
	"rowFilter.comments.edited_at": string;
	/** Format: text */
	"rowFilter.comments.message": string;
	/** Format: uuid */
	"rowFilter.comments.created_by": string;
	...
	/** Format: boolean */
	"rowFilter.shared_transactions.is_deleted": string;
	/** Format: uuid */
	"rowFilter.shared_transactions.profile_id": string;
	/** Format: uuid */
	"rowFilter.shared_transactions.group_id": string;
	/** Format: jsonb */
	"rowFilter.shared_transactions.split_amounts": string;
	/** @description profiles_transactions */
	"body.profiles_transactions": definitions["profiles_transactions"];
	/** Format: timestamp with time zone */
	"rowFilter.profiles_transactions.created_at": string;
	/** Format: double precision */
	"rowFilter.profiles_transactions.amount": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.authorized_date": string;
	/** Format: ARRAY */
	"rowFilter.profiles_transactions.category": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.category_id": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.date": string;
	/** Format: text */
	"rowFilter.profiles_transactions.merchant_name": string;
	/** Format: text */
	"rowFilter.profiles_transactions.name": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.payment_channel": string;
	/** Format: jsonb */
	"rowFilter.profiles_transactions.payment_meta": string;
	/** Format: boolean */
	"rowFilter.profiles_transactions.pending": string;
	/** Format: text */
	"rowFilter.profiles_transactions.transaction_id": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.transaction_type": string;
	/** Format: character varying */
	"rowFilter.profiles_transactions.account_id": string;
	/** Format: jsonb */
	"rowFilter.profiles_transactions.location": string;
	/** Format: uuid */
	"rowFilter.profiles_transactions.id": string;
	/** Format: boolean */
	"rowFilter.profiles_transactions.is_deleted": string;
	/** Format: uuid */
	"rowFilter.profiles_transactions.profile_id": string;
